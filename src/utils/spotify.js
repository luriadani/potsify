...
// Random mode â no popularity filter, just grab whatever Spotify returns
...
// Random discovery â any song from any genre, no filters
...
export async function createPlaylist(userId, tracks) {
  const playlist = await apiFetch(`/users/${userId}/playlists`, {
    method: 'POST',
    body: JSON.stringify({
      name: 'ð¢ Potsify â Undiscovered Tracks',
