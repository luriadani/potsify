...
async function apiFetch(path, options = {}) {
  // Read token directly from localStorage — most reliable
...
// Random mode Ã¢ÂÂ no popularity filter, just grab whatever Spotify returns
...
// Random discovery Ã¢ÂÂ any song from any genre, no filters
...
export async function createPlaylist(userId, tracks) {
  const playlist = await apiFetch(`/users/${userId}/playlists`, {
    method: 'POST',
    body: JSON.stringify({
      name: 'Ã°ÂÂÂ¢ Potsify Ã¢ÂÂ Undiscovered Tracks',
