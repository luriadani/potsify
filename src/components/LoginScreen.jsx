...
export function LoginScreen({ onLogin, isLoggedIn, userName, error }) {
  return (
    <div className={styles.root}>
      ...
      <div className={styles.content}>
        ...
        <button className={styles.loginBtn} onClick={onLogin}>
          ...
          {isLoggedIn ? `Enter as ${userName || 'you'}` : 'Connect with Spotify'}
        </button>

        <p className={styles.note}>
          {isLoggedIn
            ? 'Already connected — click to start digging.'
